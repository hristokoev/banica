			...
			<div className="relative max-w-6xl mx-auto px-4 sm:px-6">
				<div className="pt-32 pb-12 md:pt-40 md:pb-20">
					...
					<div className="max-w-xl mx-auto md:max-w-[640px] md:mx-0 text-center md:text-left">
						...
						<h1 className="h1 mb-6" data-aos="zoom-out" data-aos-delay="100">
							Traditional Bulgarian <em className="font-merienda font-italic text-orange-500">banica</em> in the heart of Prague
						</h1>
						<p className="text-lg text-neutral-300 lg:text-neutral-400 mb-5" data-aos="zoom-out" data-aos-delay="200">
							Hello 👋,<br />
						...
						<p className="text-lg text-neutral-300 lg:text-neutral-400 mb-10" data-aos="zoom-out" data-aos-delay="200">
						...
						<p className="text-lg text-neutral-300 lg:text-neutral-400 mt-10" data-aos="zoom-out" data-aos-delay="400">
						...
						<p className="text-xs text-neutral-400 lg:text-neutral-500 mt-5" data-aos="zoom-out" data-aos-delay="400">
